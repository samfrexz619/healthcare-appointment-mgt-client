  ...
  return (
    <header className='mt-4 w-full'>
      <div className='w-full flex h-12 gap-4 justify-end'>
        <div className='h-full bg-white w-90 rounded-lg flex items-center gap-2 px-2'>
        ...
        <div className='bg-white w-12 relative h-full rounded-lg grid place-items-center'>
          <Link href="#">
        ...
        <div className='flex gap-2 bg-white rounded-lg w-fit px-2 h-full items-center'>
          <div className='size-9 bg-[#0F93A5] text-white rounded-lg grid place-items-center'>
