  ...
  return (
    <div
      ...
      className={cn(
        ...
        isActive ? "border-[#0F93A5]" : "border-gray-200",
      )}
    >
      <div className="flex gap-3">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center text-xs gap-2">
            <p className="">{info.specialisation}</p>
            <i className="block size-2 bg-gray-600 rounded-full"></i>
            <p className="">{info.experience_years} years experience</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-5 space-y-3">
        ...
        <div className="flex justify-between">
          ...
          <p className="font-bold">£{info.consultation_fee}</p>
        </div>
      </div>
    </div>
  );
